...
- [ ] Explain what a token is used for.
  ...
  Sent by the server to whoever is requesting, so that they can access whatever data

- [ ] What steps can you take in your web apps to keep your data secure?

  Password requirements, not putting your API keys on GitHub, using ’secrets’

- [ ] Describe how web servers work.

  A web server is an internet-connected computer that receives the request for a web page sent by the browser, which connects the computer to the server through an IP address, which is obtained by translating the domain name
